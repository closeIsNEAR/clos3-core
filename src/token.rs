...
impl FungibleToken {
    ...
    pub fn new(prefix: u16, owner_id: AccountId, total_supply: u128) -> Self {
        let total_supply = total_supply.into();
        let mut ft = Self { accounts: LookupMap::new(format!("token:{}", prefix).as_bytes().to_vec()), total_supply };
